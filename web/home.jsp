...
function whichTenant(txt) {	
	...
	if(txt == 'UKGR'){
		document.getElementById("lblTenant").style.color = '#78BE20';
	}else if(txt == 'USGM'){
		document.getElementById("lblTenant").style.color = '#007DC6';
	}else if(txt == 'USGR'){
		document.getElementById("lblTenant").style.color = '#f26b43';
	}else if(txt == 'SAMUS'){
		document.getElementById("lblTenant").style.color = '#445561';
	}else if(txt == 'GMC'){
		document.getElementById("lblTenant").style.color = '#C4B10E';
	}else{
		document.getElementById("lblTenant").style.color = '#FF0000';
	}
...
<div ng-app="myApp">
	...
	Search : <input type="text" ng-model="search" placeholder="Type here" class="tb1" onkeyup="showTableWhileTyped(this)"><br/></br>
			...
			<div id="showtable" style="display: none">	
				<table class="bordered" BORDER="1" ng-show="(urls | filter:search).length">
					<thead>
						<tr>
							<th>Description</th>
							<th>Url</th>
